# Generated by Django 5.2.6 on 2026-05-29 15:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('department', models.CharField(choices=[('Engineering', 'Engineering'), ('Human Resources', 'Human Resources'), ('Marketing', 'Marketing'), ('Sales', 'Sales'), ('Finance', 'Finance'), ('Operations', 'Operations'), ('IT Support', 'IT Support'), ('Customer Success', 'Customer Success'), ('Product Management', 'Product Management'), ('Design', 'Design')], max_length=30)),
